...
public class MessageClient {
	public static void main(String[] args) throws Exception {
		...
		// Ask the registry running on 10.2.2.65 and listening in port 1099 for the
		// instannce of
		...
		// Make the remote method invocation. This results in the Message object being
		// transferred
		...
		// Additional output to illustrate the types involved.
